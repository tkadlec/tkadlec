# Jekyll Webmention.io Supplements: Twitter
...
task :get_twitter_webmentions do |t, args|
  ...
  client = Twitter::REST::Client.new do |config|
    config.consumer_key        = 'rxNc7TWT57vcY3Gs5zZSRiZ8W'
    config.consumer_secret     = '23qcrixUeK5Ec0XFaeiOYsPDNKIPhJAG2LwDrA56DtsUWyyhgb'
    config.access_token        = '13182702-hK4UvxrVcqHpVUfQkLHS4sjrUkXS38tJvLpndbJjC'
    config.access_token_secret = 'Ka3kGiv64F6ZeyczK1mqTVB6Y9zZU1kqko4JB6k6XP3lS'
  end

  client.search("timkadlec.com -rt").collect do |tweet|
